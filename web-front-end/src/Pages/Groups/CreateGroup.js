    ...
    <div className="card" id='appCard'>
      <div className="card-body">
        ...
        <div className="input-group flex-nowrap" id="userName">
          <input type="text" className="form-control" placeholder="Group Name" aria-label="groupname" aria-describedby="addon-wrapping" value={gname} onChange={(e) => {setGName(e.target.value)}} />
        </div>
        <div className="input-group flex-nowrap" id="serverID">
          <input type="text" className="form-control" placeholder="Server-ID" aria-label="serverId" aria-describedby="addon-wrapping" value={serverID} onChange={(e) => {setServerID(e.target.value)}} />
        </div>
